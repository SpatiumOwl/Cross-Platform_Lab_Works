...
namespace Lab_04_Lib
{
    public static class Lab01
    {
        public static void Launch(string inputPath, string outputPath)
        {
            ...
            try
            {
                ReadInputProduceAndWriteOutput(inputPath, outputPath);
        ...
        static void ReadInputProduceAndWriteOutput(string inputPath, string outputPath)
        {
            string sourceContents = ReadContentsFromFile(inputPath);
        ...
        static void WriteResultsToFile(List<int> results, string path)
        {
